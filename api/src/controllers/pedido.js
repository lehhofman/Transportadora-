...
const updatePedido = (req, res) => {
    if (req.body != null && req.body.idCliente != null && req.body.idEntrega != null && req.body.dataPedido != null && req.body.valor != null && req.body.idPedido != null) {
        const { idCliente, idEntrega, dataPedido, valor, idPedido } = req.body;
